...
$(document).ready(function(){
    console.log("ready");
        ...
        var colortext = "rgb(197, 229, 233)"     /*"rgb(29, 42, 43)"*/
        ...
        const liendino = function(option, other1, other2, other3, other4, other5, other6){
            var a = 0;
            function r(a){
        ...
        liendino(liendino1, liendino2, liendino3, liendino4, liendino5, liendino6, liendino7)
        liendino(liendino2, liendino1, liendino3, liendino4, liendino5, liendino6, liendino7)
        liendino(liendino3, liendino2, liendino1, liendino4, liendino5, liendino6, liendino7)
        liendino(liendino4, liendino2, liendino3, liendino1, liendino5, liendino6, liendino7)
        liendino(liendino5, liendino2, liendino3, liendino4, liendino1, liendino6, liendino7)
        liendino(liendino6, liendino2, liendino3, liendino4, liendino5, liendino1, liendino7)
        liendino(liendino7, liendino2, liendino3, liendino4, liendino5, liendino6, liendino1)
        ...
        window.addEventListener('scroll', () => {
            //console.log("scroll")
            if(window.scrollY >= (document.getElementById("lienintern7")).offsetTop - 55){
                if(liendino6.style.color == "rgb(128, 181, 184)"){
                    liendino6.style.color = "rgb(241, 232, 193)";
                }
